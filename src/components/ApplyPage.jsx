...
function ApplyPage() {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-wrap justify-center items-start pt-32 bg-gray-900 text-white min-h-screen px-4 md:px-10">
                <div className="w-full text-center">
                    <h1 className="text-3xl md:text-5xl font-bold pb-8">Get Your Dream Job</h1>
                    <div className="flex flex-wrap justify-center">
                        {jobs.slice(0, visibleCount).map((job, index) => (
                            <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-lg m-2 md:m-4 w-full md:w-80">
                                ...
                                <button onClick={() => handleApplyClick(job)} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                    Apply
                                </button>
                            </div>
                        ))}
